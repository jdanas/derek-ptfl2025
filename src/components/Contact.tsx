      ...
      >
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-notion-text/70 max-w-2xl mx-auto">
            Whether you have a project in mind or simply want to connect, I'd
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-notion-text">Singapore, Singapore?</p>
                  </div>
                </div>
              </div>
            </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <label
                        htmlFor="name"
                        className="block text-sm font-medium text-notion-text/70 mb-2"
                      >
                        Name
                      </label>
                      <input
