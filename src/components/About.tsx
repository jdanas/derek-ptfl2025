...
const About = () => {
  ...
  const skills = [
    { name: "React TypeScript", level: 92, icon: Code, color: "#61DAFB" },
    { name: "VLM / Computer Vision", level: 88, icon: Cpu, color: "#3178C6" },
    { name: "UI/UX Design Tokens", level: 85, icon: Palette, color: "#FF6B6B" },
    {
      ...
      >
        <div className="flex flex-col lg:flex-row gap-12 items-start">
              ...
              >
                <Card
                  ...
                  style={{
                    ...
                    background:
                      "linear-gradient(135deg, #F7F6F3 0%, #E4E2DD 100%)",
                    transformStyle: "preserve-3d",
                    boxShadow: `0 0 ${20 + glowIntensity * 30}px ${
                      glowIntensity * 15
                    }px rgba(55, 53, 47, ${0.1 + glowIntensity * 0.1})`,
                ...
                >
                  ...
                  <CardContent className="p-8 relative mt-4">
                    <div className="absolute top-0 left-0 w-full h-12 bg-notion-gray/10 flex items-center justify-between px-4">
                      <div className="text-notion-text text-sm font-bold tracking-widest uppercase">
                        Developer Series
                      </div>
                      <div className="flex items-center gap-2">
                        <Diamond className="h-4 w-4 text-notion-text/60" />
                        <span className="text-xs font-mono text-notion-text/60">
                          25/100
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="mt-8 mb-4 flex items-center justify-between">
                      <h3 className="text-2xl font-bold text-notion-text">
                        The Stateless One
                      </h3>
                      <div className="flex items-center justify-center w-10 h-10 rounded-full bg-notion-gray/20 border border-notion-gray/30 text-notion-text font-bold">
                        5
                      </div>
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-notion-gray/5 via-white/30 to-notion-gray/10 backdrop-blur-sm p-4 rounded-lg border border-notion-gray/20 mb-3 relative overflow-hidden">
                      ...
                      <div className="text-sm text-notion-text font-medium mb-3 flex items-center gap-2">
                        ...
                        <div className="ml-auto text-xs text-notion-text/40 font-mono">
                          LVL{" "}
                          {Math.floor(
                            skills.reduce(
                      ...
                      <div className="mt-3 pt-2 border-t border-notion-gray/20 flex items-center justify-between">
                        <div className="text-[10px] text-notion-text/40 font-mono">
                          SKILL TREE
                        </div>
                        <div className="flex items-center gap-1">
                          <div className="w-1.5 h-1.5 rounded-full bg-green-400 animate-pulse"></div>
                          <span className="text-[10px] text-notion-text/50 font-mono">
                            ACTIVE
                          </span>
                        </div>
                      </div>
                    ...
                    <div className="flex justify-between items-center mt-4 pt-3 border-t border-notion-gray/20">
                      <div className="text-right">
                        <div className="text-[10px] text-notion-text/40 font-mono mb-1">
                          CARD ID
                        </div>
                        <div className="text-[10px] text-notion-text/60 font-mono">
                          DEV-2025-{Math.floor(Math.random() * 1000)}
                        </div>
                      </div>
                      <div className="flex gap-4">
                        <div className="flex flex-col items-center">
                          <span className="text-[10px] text-notion-text/40">
                            ATK
                          </span>
          ...
          <div className="lg:w-1/2">
            <div className="pill inline-block mb-3 hover:scale-105 transition-transform">
              About Me
            </div>
